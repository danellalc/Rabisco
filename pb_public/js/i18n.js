export const dictionaries = {
  en: {
    ...
    newDocShort: '+ Document',
    uploadShort: 'Upload files',
    listHint: 'Double click opens · right click shows options',
    addMenu: 'Add',
    emptyFolderTitle: 'This folder is empty',
    emptyDriveTitle: 'No folders yet',
    signOut: 'Sign out',
    pin: 'Pin',
    unpin: 'Unpin',
    delete: 'Delete',
    ...
    emptyFolder: 'Drop files here, or create a folder or a document above. What you place on the board stays listed here.',
    emptyDrive: 'Create your first folder above. Every folder has a board where you arrange files, texts and images.',
    ...
    boardOfFolder: 'Board of this folder',
  ...
  'pt-BR': {
    ...
    newFolderShort: '+ Pasta',
    newDocShort: '+ Documento',
    uploadShort: 'Enviar arquivos',
    listHint: 'Duplo clique abre · botão direito mostra opções',
    addMenu: 'Adicionar',
    emptyFolderTitle: 'Esta pasta está vazia',
    emptyDriveTitle: 'Nenhuma pasta ainda',
    signOut: 'Sair',
    pin: 'Fixar',
    unpin: 'Desafixar',
    delete: 'Apagar',
    ...
    emptyFolder: 'Solte arquivos aqui, ou crie uma pasta ou um documento ali em cima. O que você puser no quadro continua listado aqui.',
    emptyDrive: 'Crie sua primeira pasta ali em cima. Toda pasta tem um quadro onde você organiza arquivos, textos e imagens.',
    ...
    boardOfFolder: 'Quadro desta pasta',
    groupFolders: 'Pastas',
    groupDocs: 'Documentos',
    groupFiles: 'Arquivos',
    kindBoard: 'quadro',
    frame: 'Moldura',
