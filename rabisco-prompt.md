...
- Total do front (HTML+CSS+JS) medido no `build/` minificado: até 104 KB sem gzip, até 32 KB com gzip (24 KB em 19/09/2026 para caber tabela de planilha, tema e largura configuráveis, arrastar imagem e histórico próprio de desfazer; 32 KB em 20/09/2026 para caber PWA, exportar, imprimir e compartilhar da galeria).
- JavaScript somado até 80 KB. `style.css` até 16 KB.
